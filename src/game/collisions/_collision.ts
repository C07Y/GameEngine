...
import {CollideLayers, CollideTypes} from "../collisions/states"


export default abstract class Collision {
  protected abstract intersect(bd : NPC) : void;
  public abstract scale(floats: T.Box);
  public abstract scaleTo(floats: T.Box);
  ...
  public update(to: Array<NPC>): void {
